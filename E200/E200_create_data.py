...
def E200_create_data(group_parent, group_name, dim=1):
    """
    .. versionadded:: 1.4
    ...
    if group_name in group_parent.keys():
        logger.error('Data with name "{}" already exists.'.format(group_name))
    ...
    group_child.create_dataset('dat', shape=(0, ) * dim, maxshape=(None, ), dtype=ref_dtype)
