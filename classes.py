...
class Data(object):
	...
	#  def _drill(self,data,*args):
	#          if args == ():
	#                  return data
	#          else:
	#                  data = data[args[0]]
	#                  return self._drill(data,*args[1:])

	#  def rdrill(self,*args):
	#          return self._drill(self.read_file,*args)
	#  def wdrill(self,*args):
	#          return self._drill(self.write_file,*args)
